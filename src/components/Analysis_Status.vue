<template>
	...
	<div class="echarts">
		...
		<b-button @click="Delay(1000)">Test</b-button>
			...
			*/
			makeData(){
				 for (var i = 0; i < 300; i++) {
						...
						console.log("======>",areaName,areaVale,this.geoCoordMap[areaName][0],this.geoCoordMap[areaName][1])
						if (i%3==0){
