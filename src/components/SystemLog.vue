<template>
  <div >
    ...
    <b-table
		...
		class="mt-1 "
		striped hover
		caption-html="<strong class='text-primary border-left  border-success'>日志列表</strong>"
		caption-top="true"
		show-empty
	    stacked="md"
		:busy.sync="isBusy"
  ...
  export default {
    data() {
      return {
        ...
        fields: [
					'index',
					{ key: 'product_type', 	label: '日志编号' },
					{ key: 'sn', 			label: '日期', sortable: true, sortDirection: 'desc' },
					{ key: 'region', 		label: '日志内容' },
					{ key: 'hospital', 		label: '操作员' },
					{ key: 'checkman', 		label: '审批员' },
				],
